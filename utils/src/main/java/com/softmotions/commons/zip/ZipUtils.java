...
public class ZipUtils {
    ...
    public static void zipFile(File file, File outFile, boolean plain) throws IOException {
        zipFiles(new File[]{file}, outFile.toString(), plain, false, null, null);
    }
    ...
    public static void zipFiles(File[] files, String outFileName) throws IOException {
        zipFiles(files, outFileName, false, false, null, null);
    }

    public static void zipFiles(File[] files, String outFileName, boolean plain,
                                boolean jar, Manifest mf) throws IOException {
        zipFiles(files, outFileName, plain, jar, mf, null);
    }
     ...
     */
    public static void zipFiles(File[] files, String outFileName, boolean plain,
                                boolean jar, Manifest mf, String encoding) throws IOException {
