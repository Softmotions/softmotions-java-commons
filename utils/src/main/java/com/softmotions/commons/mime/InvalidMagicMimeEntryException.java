...
class InvalidMagicMimeEntryException extends RuntimeException {
    ...
    InvalidMagicMimeEntryException(List mimeMagicEntry) {
        super("Invalid Magic Mime Entry: " + mimeMagicEntry.toString());
    }

    InvalidMagicMimeEntryException(List mimeMagicEntry, Throwable t) {
        super("Invalid Magic Mime Entry: " + mimeMagicEntry.toString(), t);
    }

    InvalidMagicMimeEntryException(Throwable t) {
        super(t);
    }

    InvalidMagicMimeEntryException(String message, Throwable t) {
        super(message, t);
    }
}
