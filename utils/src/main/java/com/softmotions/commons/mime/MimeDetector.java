...
public abstract class MimeDetector {
     ...
     * @
     */
    protected abstract Collection<MimeType> getMimeTypesFileName(final String fileName);
     ...
     * @
     */
    protected abstract Collection<MimeType> getMimeTypesFile(final File file);
     ...
     * @
     */
    protected abstract Collection<MimeType> getMimeTypesURL(final URL url);
     ...
     * @return Collection of matched MimeType(s)
     */
    protected abstract Collection<MimeType> getMimeTypesInputStream(final InputStream in);
     ...
     * @
     */
    protected abstract Collection<MimeType> getMimeTypesByteArray(final byte[] data);
